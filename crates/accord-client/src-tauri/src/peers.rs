...
/// regional candidates are too thin, and to the bundled defaults when the repo
/// is unreachable.
///
/// # Errors
/// Returns an error string when no peer (fetched or bundled) is reachable.
pub async fn select_public_peers() -> Result<Vec<String>, String> {
    ...
    if candidates.is_empty() {
        // Repo unreachable - fall back to the bundled defaults.
